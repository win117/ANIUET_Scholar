...
export const apiHelpers = {
  ...
  getUnreadMessageCount: async (accessToken: string) => {
    try {
      ...
      if (!response.ok) {
        // If server returns error, return success with 0 count instead of throwing
        console.warn('Server returned error for unread count, returning 0');
      ...
      // Network error or other issue - return 0 instead of throwing
      console.warn('Network error fetching unread count, returning 0:', error);
      return { success: true, unreadCount: 0 };
    }
  },
